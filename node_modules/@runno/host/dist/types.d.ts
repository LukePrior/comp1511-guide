export declare type Runtime = "python" | "quickjs" | "sqlite" | "clang" | "clangpp" | "ruby";
export declare type Syntax = "python" | "js" | "sql" | "cpp" | "ruby" | undefined;
...
export declare type RuntimeMethods = {
    showControls: () => void;
    hideControls: () => void;
    showEditor: () => void;
    hideEditor: () => void;
