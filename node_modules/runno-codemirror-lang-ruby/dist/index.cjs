...
const parser$1 = lr.LRParser.deserialize({
  ...
  nodeNames: "⚠ LineComment BlockComment Program AssignmentExpression LeftHandSide Variable VarName nil self Arg Primary Literal String Number BooleanLiteral Symbol FunctionName def ArgDeclaration ArgumentList end",
  maxTerm: 67,
  skippedNodes: [0,1,2],
  repeatNodeCount: 1,
...
const rubyLanguage = language.LRLanguage.define({
    parser: parser.configure({
        props: [
            language.indentNodeProp.add({
                Parenthesized: language.delimitedIndent({ closing: ")" }),
            ...
            highlight.styleTags({
                "for while do if else switch begin rescue ensure return throw break continue default case": highlight.tags.controlKeyword,
                "def end": highlight.tags.definitionKeyword,
                VarName: highlight.tags.variableName,
                ...
                "if then else unless": highlight.tags.controlKeyword,
...
function ruby() {
    return new language.LanguageSupport(rubyLanguage, rubyLanguage.data.of({
        autocomplete: autocomplete.ifNotIn(["LineComment", "BlockComment", "String", "IndentedString"], autocomplete.completeFromList(snippets)),
    }));
}

exports.parser = parser;
exports.ruby = ruby;
exports.rubyLanguage = rubyLanguage;
